...
<CodeBlock codeText={`npm i @benchmarkdigital/bmd-react-bootstrap`} />
...
[Click here](https://github.com/ezzio-salas/react-bootstrap/code-sandbox-examples/blob/master/README.md)
to check them out.
